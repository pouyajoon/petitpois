...
$.ui.plugin.add('timepickr', 'val', {
    initialized: function(e, ui) {
        ...
        var h = ui.options.val.substring(0, 2);    
        var m = ui.options.val.substring(3, 5);
//        console.log(h, m );
        $("ol.hours span:contains('" + h + "')").addClass("ui-state-hover");
        $("ol.minutes span:contains('" + m + "')").addClass("ui-state-hover");
